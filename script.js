document.addEventListener("DOMContentLoaded", function () {
    const clickableAreas = [
        { id: "head", x: 685, y: 80, radius: 50 },
        { id: "throat", x: 685, y: 260, radius: 60 },
        { id: "g_center", x: 685, y: 460, radius: 70 },
        { id: "sacral", x: 685, y: 700, radius: 80 },
        { id: "ego", x: 840, y: 500, radius: 50 }
    ];

    const planetaryThemes = [
        { id: "design_50_6", gate: "50", x: 160, y: 120 },
        { id: "design_3_6", gate: "3", x: 160, y: 180 },
        { id: "design_43_6", gate: "43", x: 160, y: 240 },
        { id: "design_47_3", gate: "47", x: 160, y: 300 },
        { id: "design_40_5", gate: "40", x: 160, y: 360 },
        { id: "personality_60_4", gate: "60", x: 1210, y: 120 },
        { id: "personality_56_4", gate: "56", x: 1210, y: 180 },
        { id: "personality_43_4", gate: "43", x: 1210, y: 240 },
        { id: "personality_7_2", gate: "7", x: 1210, y: 300 }
    ];
    ...
    function highlightGate(gate) {
        ...
        if (correspondingGate) correspondingGate.style.backgroundColor = "rgba(0, 255, 255, 0.5)";
    }

    function removeHighlight(gate) {
        let correspondingGate = document.querySelector(`[data-id="gate_${gate}"]`);
        if (correspondingGate) correspondingGate.style.backgroundColor = "transparent";
    }
